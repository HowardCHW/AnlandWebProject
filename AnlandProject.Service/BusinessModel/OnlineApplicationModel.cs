...
namespace AnlandProject.Service.BusinessModel
{
    public class OnlineApplicationModel
    {
        ...
        public DateTime? ApplyBirth { get; set; }
        ...
        public string Sarea1 { get; set; }
        public string Sarea2 { get; set; }
        public string Sarea3 { get; set; }
        public string Sarea4 { get; set; }
        public string Sarea5 { get; set; }
        public string AreaNo1 { get; set; }
        public string AreaNo2 { get; set; }
        public string AreaNo3 { get; set; }
        public string AreaNo4 { get; set; }
        public string AreaNo5 { get; set; }
        public string AreaYear1 { get; set; }
        public string AreaYear2 { get; set; }
        public string AreaYear3 { get; set; }
        public string AreaYear4 { get; set; }
        public string AreaYear5 { get; set; }
        ...
        public int? AppItem1 { get; set; }
        public int? AppItem2 { get; set; }
        public int? AppItem3 { get; set; }
        public string Year1 { get; set; }
        public string Year2 { get; set; }
        public string Year3 { get; set; }
        public string DocItem1 { get; set; }
        public string DocItem2 { get; set; }
        public string DocItem3 { get; set; }
        public string DocItem4 { get; set; }
        ...
        public DateTime? GetAppDate { get; set; }
        public string GetAppTime { get; set; }
